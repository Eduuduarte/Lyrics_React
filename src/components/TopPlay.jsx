...
import { useGetTopChartsQuery } from '../redux/services/shazaCore';
    ...
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[400px] max-w-full flex flex-col">
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          <h2 className="text-white font-bold text-2xl">Paradas de Sucesso</h2>
          <Link to="/top-charts">
      ...
      <div className="w-full flex flex-col mt-8">
        <div className="flex flex-row justify-between items-center">
          <h2 className="text-white font-bold text-2xl">Top Artistas</h2>
          <Link to="/top-artists">
            <p className="text-gray-300 text-base cursor-pointer">Veja Mais</p>
          </Link>
        </div>
